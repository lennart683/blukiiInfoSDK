...
typedef SWIFT_ENUM(NSInteger, BKBlukiiType, closed) {
/// Blukii Type “Unknown”
...
typedef SWIFT_ENUM(NSInteger, BKCommonState, closed) {
/// State On
  BKCommonStateOn = 0,
/// State Off
  BKCommonStateOff = 1,
...
typedef SWIFT_ENUM(NSInteger, BKDiscoveryError, closed) {
...
typedef SWIFT_ENUM(NSInteger, BKDiscoveryInfo, closed) {
...
typedef SWIFT_ENUM(NSInteger, BKSecureBeaconState, closed) {
